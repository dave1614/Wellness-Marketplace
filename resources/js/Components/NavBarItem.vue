...
// console.log(page.value.props.unread_notis)
const is = computed(() => {
  if (props.item.href) {
    return 'a'
  }
...
<template>
  ...
  >
    ...
    >
      <div v-if="item.type && page.props.unread_notis > 0" class="absolute rounded-full p-1 bg-red-500 right-0 m-1 top-0"></div>
